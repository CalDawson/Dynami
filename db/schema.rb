...
ActiveRecord::Schema.define(version: 2021_12_06_004406) do
  ...
  create_table "meal_eatens", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_meal_eatens_on_user_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "username"
    t.string "avatar_url", default: "https://upload.wikimedia.org/wikipedia/commons/6/67/User_Avatar.png"
